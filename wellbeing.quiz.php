...
<body>
			...
			<form method="POST" action="ajoutSuivit.php">
				<div class="quiz">
					...
					<div class="slidecontainer" align="center">
						...
						<h3>Value: <span class="slidervalue" id="sommeil-value"></span></h3>
					</div>
				</div>     
				<div class="quiz">
	...
	<script>
		...
		/* TODO: fixé la valeur initiale à 1. */
		
		/* console.log('String: sliderID = '+sliderID); */
		console.log('String: slidervalue = '+sValue); 

		var slider = document.getElementById(sliderID);
		/* console.log('Objet: slider = '+slider); */

		var sliderValue = document.getElementById(sValue);
		/* console.log('Object: sliderValue = '); */
